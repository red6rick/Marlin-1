...
#define CUSTOM_MACHINE_NAME "FussyHussy"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 100, 400, 430 }   // an external reference used 410 for extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, 2, -4.53 }
